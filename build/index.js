(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["svgCharts"] = factory();
	else
		root["svgCharts"] = factory();
})(this, function() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function pointAngleInDegrees(value, sum) {
	...
	function generatePointsAndAnglesOnCirclePerimeter(values, colors, radius, strokeSize) {
	    ...
	    var anglesInDegrees = summarizedValues.map(function (val) {
	        return pointAngleInDegrees(val, sum);
	    });
